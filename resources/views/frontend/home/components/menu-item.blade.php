        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    <h4>Bubble Tea</h4>
                    <h2>Our Popular Drinks</h2>
                    <span>
                        <img src="images/heading_shapes.png" alt="shapes" class="img-fluid w-100">
                    </span>
                    <p>Discover our delightful Bubble Tea Creations—where vibrant flavors meet playful textures! From the classic richness of Brown Sugar Milk Tea to the tropical refreshment of Mango Fruit Tea, each drink is crafted with the freshest ingredients and a variety of exciting toppings.</p>
                </div>
            </div>
        </div>
